class UserAccount:
    def __init__(self, user_account_id: int, account_id: int, user_id: int, account_type_id: int, account_name: str, icon: str, account_type_1: str, account_type_2: str, account_type_3: str):
