...
class TransactionPostgresDao(TransactionDao):
    ...
    def upsert(self, transactions: List[Transaction]):
        sql = f'''
        INSERT INTO transaction (id, date, account_id, user_id, title, amount, debit_credit_indicator, closing_balance, category_id) VALUES %s 
        ON CONFLICT (id) 
        DO UPDATE SET
            date = EXCLUDED.date,
        ...
        values = [(t.transaction_id, t.date, t.account_id, t.user_id, t.title, t.debit_or_credit_amount, t.is_debit_or_credit,
