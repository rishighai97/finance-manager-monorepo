...
class Transaction:
    def __init__(self, transaction_id: str, date: datetime, account_id: str, title: str, debit_or_credit_amount: float, is_credit_amount: bool, closing_balance: float = None,
